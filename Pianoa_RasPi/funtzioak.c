...
int pinIrakurri()
{
	...
	if(digitalRead(8)) sakatua = 1;
	else if(digitalRead(9)) sakatua = 2;
	else if(digitalRead(7)) sakatua = 3;
	else if(digitalRead(0)) sakatua = 4;
	else if(digitalRead(2)) sakatua = 5;
	else if(digitalRead(3)) sakatua = 6;
	else if(digitalRead(12)) sakatua = 7;
	else if(digitalRead(13)) sakatua = 8;
	else if(digitalRead(14)) sakatua = 9;
	else if(digitalRead(30)) sakatua = 10;
	else if(digitalRead(21)) sakatua = 11;
	else if(digitalRead(22)) sakatua = 12;
